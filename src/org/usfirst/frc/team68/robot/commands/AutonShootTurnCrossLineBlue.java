...
public class AutonShootTurnCrossLineBlue extends CommandGroup 
{    	

	public AutonShootTurnCrossLineBlue() 
    { 
		...
		addParallel(new IntakeDown());//Put the intake down
     	...
     	addSequential(new DriveMM(0,-4.5,0,240,0,240)); //Turn using right side only
    	addSequential(new WaitCommand(.5));
